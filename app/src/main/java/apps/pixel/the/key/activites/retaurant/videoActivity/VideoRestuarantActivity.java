package apps.pixel.the.key.activites.retaurant.videoActivity;
...
//        }
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (getIntent().hasExtra(Constant.KEY_VIDEO_URL)) {
            videoUri = getIntent().getStringExtra(Constant.KEY_VIDEO_URL);
