...
public class OfferResAdapter extends RecyclerView.Adapter<OfferResAdapter.ViewHolder> {
   ...
   // private final OfferResAdapter.OnClickHandler onClickHandler;
    ...
    public OfferResAdapter(Context context, List<String> listResNames, List<String> listMealNames, List<String> listImgLocation
            , List<String> listPresentange, List<String> listImages) {
    ...
    public void onBindViewHolder(@NonNull final OfferResAdapter.ViewHolder holder, final int listPosition) {
        try {
            ...
            Picasso.get()
                    .load(Constant.BASE_URL_HTTP+listImages.get(listPosition))
                    .fit()
                    .centerCrop()
                    .into(holder.imgMeal);
