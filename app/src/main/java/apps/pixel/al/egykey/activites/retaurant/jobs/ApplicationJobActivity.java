package apps.pixel.al.egykey.activites.retaurant.jobs;
...
import apps.pixel.al.egykey.dialog.restuarant.DialogCity;
import apps.pixel.al.egykey.dialog.restuarant.DialogEducational;
import apps.pixel.al.egykey.dialog.restuarant.DialogExperience;
import apps.pixel.al.egykey.utilities.CairoBoldButton;
import apps.pixel.al.egykey.utilities.CairoBoldTextView;
import apps.pixel.al.egykey.utilities.GetFilePathFromDevice;
import permissions.dispatcher.NeedsPermission;
import permissions.dispatcher.RuntimePermissions;

import static apps.pixel.al.egykey.utilities.Constant.convertFileToByteArray;
