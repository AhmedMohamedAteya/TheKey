package apps.pixel.al.egykey.adapters.beautyAndHealth;
...
public class BeautyAndHealthHomeAdapter extends RecyclerView.Adapter<BeautyAndHealthHomeAdapter.ViewHolder> {

    private final BeautyAndHealthHomeAdapter.OnClickHandler onClickHandler;
    ...
    public BeautyAndHealthHomeAdapter(Context context, List<String> sinceList, List<String> idList, List<String> arabicNames, List<String> englishNames, List<String> urlsBackGrounds, List<String> urlsLogos, BeautyAndHealthHomeAdapter.OnClickHandler onClickHandler) {
    ...
    @NonNull
    @Override
    public BeautyAndHealthHomeAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.restaurant_item_layout, parent, false);
        return new BeautyAndHealthHomeAdapter.ViewHolder(view);
    }
    ...
    @Override
    public void onBindViewHolder(@NonNull final BeautyAndHealthHomeAdapter.ViewHolder holder, final int listPosition) {
