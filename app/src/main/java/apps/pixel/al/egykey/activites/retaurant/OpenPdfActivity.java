...
public class OpenPdfActivity extends AppCompatActivity {
    ...
    private void openWebSite() {
        ...
        mWebView.loadUrl("https://docs.google.com/gview?embedded=true&url=".trim() + pdfLink.trim());
        Log.d("URL_IS_", "https://docs.google.com/gview?embedded=true&url=".trim() + pdfLink.trim());
    }
