...
public class Hospital {
    ...
    private List<apps.pixel.al.egykey.models.selectedBeauty.Images> Images;
    ...
    public List<apps.pixel.al.egykey.models.selectedBeauty.Images> getImages ()
    {
        return Images;
    }

    public void setImages (List<apps.pixel.al.egykey.models.selectedBeauty.Images> Images)
    {
        this.Images = Images;
    }
